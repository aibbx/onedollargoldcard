  ...
  return (
    <div className="space-y-6">
      ...
      <ul className="space-y-4 text-gray-700">
        ...
        <InfoPoint text="Selection uses Chainlink VRF (Verifiable Random Function) for transparency" />
      ...
      <div className="bg-gold-50 p-6 rounded-lg border border-gold-200 mt-6">
        ...
        <p className="text-gray-700">
          ...
          verifies the fund has reached $10 million, uses Chainlink VRF for provably fair random 
