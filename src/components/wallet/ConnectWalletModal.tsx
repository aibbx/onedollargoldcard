        ...
        <div className="p-6">
          ...
          <div className="space-y-3">
            <button
              ...
              className="w-full p-4 bg-white border border-gray-200 rounded-xl hover:bg-gray-50 transition-colors flex items-center gap-3"
            >
              <img src="/wallet-icons/phantom-icon.svg" alt="Phantom" className="w-8 h-8" />
              <span className="font-medium text-lg">Phantom</span>
            </button>
            ...
            >
              ...
              <span className="font-medium text-lg">Solflare</span>
            </button>
            ...
            >
              ...
              <span className="font-medium text-lg">OKX Wallet</span>
            </button>
