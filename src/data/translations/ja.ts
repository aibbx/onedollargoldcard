export const ja = {
  ...
  'howItWorks.step3.desc': 'プールが1000万ドルに達すると、ランダムに当選者が選ばれます。',
  'howItWorks.step4.title': '資金を受け取る',
  'howItWorks.step4.desc': '当選者は500万ドルを受け取り、500万ドルは次のラウンドに残ります。',
  ...
  // Trump quotes
  'trump.support1': "アメリカには実力主義のシステムが必要です。ゴールドカードイニシアチブで最高の人材を獲得します。私を信じてください！",
  'trump.support2': "ゴールドカードは最高かつ最も賢い人々がアメリカに来るための最良の方法です。素晴らしいチャンスです！",
  'trump.support3': "私たちは公正で迅速、素晴らしい道を創ります。ゴールドカードプログラムは本当に特別なものです。",
  'trump.support4': "最も賢い人々がアメリカに来ることを望みます。ゴールドカードでそれを実現します。とてつもなく大きなことになるでしょう！",
