...
export const zhCN: TranslationDictionary = {
  ...
  'donation.minAmount': '最低捐赠金额为 $1.05 USD1',
  'donation.fee': '服务费 (5%)',
  'donation.total': '总计',
  'donation.confirmation': '我同意条款和条件，并确认我有资格参加本计划',
  'donation.button': '捐赠 USD1',
  ...
  // Wallet connection
  'wallet.connect': '连接钱包',
  'wallet.description': '连接您的 EVM 钱包以捐赠并参与黄金卡计划',
  ...
  'notify.donation.error.insufficient': '您的钱包中没有足够的 USD1，请添加更多 USD1 后重试',
  'notify.donation.error.rejected': '您在钱包中拒绝了交易，准备好批准时请重试',
  'notify.donation.error.timeout': '交易超时，网络可能拥堵，请重试',
  'notify.donation.error.tokenAccount': '您需要一个 USD1 代币账户，请先向您的钱包添加一些 USD1',
